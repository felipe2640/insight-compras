...
1. White-Label Dinâmico:
   - Implementar `config/tenants/tipos.ts` com contrato estrito de tenant (paleta de cores Hex e RGB, logos, filiais, assinatura Insight Direto e conversor `hexParaRgb`).
